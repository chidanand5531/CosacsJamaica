...
public class COS20_HomeDelivery extends BaseClass{
	...
	public static String SendingLocation="174 LUCKY DOLLAR MANDEVI";
	public static String ExpectedSearchShipmentPageTitle="Search Shipments";
	public static String DeleveryBranch="174 LUCKY DOLLAR MANDEVI";
	...
	public static String Truck="HORACE PERKINS";
