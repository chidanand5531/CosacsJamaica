...
public class Xpath {
	...
	public static class LocationCreation {
		...
		public static String createGrn = "//li[@class='dropdown open']//a[contains(text(),'Create')]";
	 ...
	 public static class Repossessed
		{
			...
			public static String randomproduct="(//a[@class='ng-binding'])[15]";   //Update for every run
			...
			public static String volume="(//div//td[.='Volume'])[14]";  //Update for every run
	...
	public static class toastMassage
{
 public static String Message_catch="//div[@id='growlcontainer']";
	...
	public static class LocalProduct
	{
		...
		public static String WarrantyCheckBox = "//div//label[contains(text(),'Warrantable')]/..//input[@type='checkbox']";
	...
	public static class Picking
	{
		...
		public static String ShipmentPick="//tbody//tr[1]//td//span[@title='Click to add this item']";
	...
	public static class WarrantyPromotions
	{
		...
		public static String ToEffDateVal = "//table[@class='ui-datepicker-calendar']/tbody/tr[3]/td/a[contains(text(),'29')]";
		...
		public static String StartDatePick = "//div[@id='ui-datepicker-div']//tbody/tr/td/a[contains(text(),'29')]";
		public static String EndDate = "//input[@id='promotionEndDate']";
		public static String EndDatePick = "//div[@id='ui-datepicker-div']//tbody/tr/td/a[contains(text(),'30')]";
	...
	public static class WarrantyProductLink
	{
		...
		public static String EffDatePic = "//table[@class='ui-datepicker-calendar']/tbody/tr/td/a[contains(text(),'29')]";
